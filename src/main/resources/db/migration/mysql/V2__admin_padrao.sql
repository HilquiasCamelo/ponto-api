...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'hilquias IT');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'admin@hilquias.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL,
